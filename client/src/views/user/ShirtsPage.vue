<template>
  <div class="category-page">
    <!-- Phần banner -->
    <div class="banner">
      <img src="https://file.hstatic.net/1000253775/collection/ao_be09665c11774159bfcd3c847542b1bf_master.png" alt="Shirts Banner" />
    </div>
...
onMounted(async () => {
  try {
    ...
    shirts.value = response.data.filter((product) => product.category.toLowerCase().includes('áo'));
